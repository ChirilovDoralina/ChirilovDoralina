...
%->Vom folosi functia plot pentru a genera grafice cu parametrii t1 si x1, t2 si x2, t3 si x3, t4 si x4
plot(t1,x1);
plot(t2,x2);
plot(t3,x3);
plot(t4,x4);
...
%->Vom folosi functia plot pentru a genera grafice cu parametrii t5 si x5, t6 si x6, t7 si x7, t8 si x8
plot(t5,x5);
plot(t6,x6);
plot(t7,x7);
plot(t8,x8);
